...
def export_cea(request):
    ...
    database = MySQLdb.connect (h="amritha.mysql.pythonanywhere-services.com", user = "amritha", passwd = "lilies19", charset="utf8", db = "amritha$costtool") 
    ...
    if request.method == 'POST':
       ...
       if infform.is_valid():
          ...
          if 'priceExists' in request.session:
             if equest.session['priceExists'] == False:
