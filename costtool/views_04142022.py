...
#from .models import SharedProj, Distribution, About, Videos, FileUpload, About,Transfers,Agencies,Login, Benefits,UserProfile,Projects, Programs, ProgramDesc, ParticipantsPerYear, Effectiveness, Prices, Settings,GeographicalIndices, GeographicalIndices_orig, InflationIndices_orig, Ingredients
...
def import_inf(request):
    ...
    # Create the INSERT INTO sql query
    query = """INSERT INTO costout_inflationindices_orig (yearCPI, indexCPI) VALUES (%s, %s)"""
